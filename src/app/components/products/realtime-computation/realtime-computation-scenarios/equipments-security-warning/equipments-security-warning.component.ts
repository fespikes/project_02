...
export class EquipmentsSecurityWarningComponent extends ScenariosChildComponent implements OnInit {
	constructor(
	...
	ngOnInit() {
		try {
			...
			this.data = productDetails.scenarios.equipmentsSecurityWarning;
		} catch (e) {
